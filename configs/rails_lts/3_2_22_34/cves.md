# List of vulnerabilities addressed by Rails 3.2.22.34 LTS

This is a known list of all known vulnerabilities relevant for Rails 3.2.22.34 LTS.
...
- CVE-2023-22792
  - ReDoS in ActionPack
  - NOTE: Please consider to upgrade to 3.2.22.35 instead, this release has a bug
