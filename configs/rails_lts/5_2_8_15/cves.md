# List of vulnerabilities addressed by Rails 5.2.8.15 LTS

This is a known list of all known vulnerabilities relevant for Rails 5.2.8.15 LTS.
...
- CVE-2023-22792
  - ReDoS in ActionPack
  - NOTE: Please consider to upgrade to 5.2.8.16 instead, this release has a bug
