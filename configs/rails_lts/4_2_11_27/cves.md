# List of vulnerabilities addressed by Rails 4.2.11.27 LTS

This is a known list of all known vulnerabilities relevant for Rails 4.2.11.27 LTS.
...
- CVE-2023-22792
  - ReDoS in ActionPack
  - NOTE: Please consider to upgrade to 4.2.11.28 instead, this release has a bug
