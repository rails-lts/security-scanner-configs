  ...
  class CveTemplate
    ...
    def generate
      File.write path, <<~YML
        ...
        cve_identifier: #{cve}
        snyk_identifiers:
          - TODO # Search for a SNYK ID on https://security.snyk.io/vuln/rubygems?search=#{cve}
        ghsa_identifier: TODO # Search for the GHSA on https://github.com/advisories?query=#{cve}
...
task :add_cve do
  ...
  puts "> Now open #{template.path} and fill in all information."
end
